...
parent_cg_to_joint  = [[0, hingeDepth]]# [[3, 0],[0,1]] # Vectors from parent's center-of-gravity (CG) to the joint location.
joint_to_child_cg   = [[0,flapCG[2]-(hingeDepth)]] # Vectors from the joint to the child's CG.
