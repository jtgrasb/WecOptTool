...
simu.simMechanicsFile = 'foswecFlaps.slx';      % Specify Simulink Model File
...
body(2).mass = 0.5*(.05*.76*.56)*1000; % mass of flaps is half of displaced mass to add buoyancy
body(2).inertia = [1.2 1.19 1.2];
...
pto(1).location = [-1.44/2 0 -0.5];                      % PTO Location [m]
