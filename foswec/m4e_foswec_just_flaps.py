...
joints              = [[0, 1],[0, 2]] # Joint connectivity: [parent, child]
types               = [ 'R', 'R']  # Joint types: 'R' for revolute, 'P' for prismatic, 'F' for floating
parent_cg_to_joint  = [[flap1CG[0],platformCG[2]+.04],[flap2CG[0],platformCG[2]+.04]]# [[3, 0],[0,1]] # Vectors from parent's center-of-gravity (CG) to the joint location.
joint_to_child_cg   = [[0,flap1CG[2]-(-0.5)],[0,flap2CG[2]-(-0.5)]] # Vectors from the joint to the child's CG.
