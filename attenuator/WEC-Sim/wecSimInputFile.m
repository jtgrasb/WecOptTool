...
body(1).mass = 'equilibrium';                   
    ...
    % Weight.
body(1).inertia = [0 (1/12)*0.5*1000*(1^2 + 1^2) 0];  % Moment of Inertia [kg*m^2]     

% Spar/Plate
body(2) = bodyClass('hydroData/attenuator.h5'); 
body(2).geometryFile = 'geometry/cyl_0_5.stl'; 
body(2).mass = 'equilibrium';                   
body(2).inertia = [0 (1/12)*0.5*1000*(1^2 + 1^2) 0];
...
pto(2).location = [-2 0 0];                      % PTO Location [m]
