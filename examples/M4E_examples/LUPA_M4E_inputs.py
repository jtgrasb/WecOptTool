...
parent_cg_to_joint  = [[0, spar_cg[2]],[0,0]]# [[3, 0],[0,1]] # Vectors from parent's center-of-gravity (CG) to the joint location.
joint_to_child_cg   = [[np.nan, np.nan],[0,float_cg[2]-spar_cg[2]]] # Vectors from the joint to the child's CG.
